...
export function OutlineToolSettings() {
  ...
  return (
    <div>
      ...
      <label data-tip="Maximum depth per pass. Multiple passes are used to reach full thickness. Rule: don't exceed 50-100% of bit diameter per pass.">
        Depth/pass
      ...
      {profileCutId ? (
        <>
          <h3 data-tip="Small bridges of material left during the profile through-cut to keep the piece from falling. Cut with a hand saw after CNC finishes.">
            Profile tabs
          </h3>

          <label data-tip="Number of tabs evenly spaced around the profile through-cut.">
            Tab count
        ...
        <p style={{ fontSize: 10, color: '#555', marginTop: 8 }}>
          Tab options appear when you pick an outer <strong style={{ color: '#ff8800' }}>profile</strong> shape.
        </p>
      )}
    </div>
  );
